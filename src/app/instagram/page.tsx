export default function InstagramLanding() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12 space-y-6">
      <h1 className="text-2xl sm:text-3xl font-semibold">Hi Instagram 👋</h1>
      <p className="text-sm text-gray-700 dark:text-gray-300">Interested in Calendne? Tell us your goals and we’ll guide you.</p>
